package com.example.fadedphotocollage.Image;
...
public class ImageUtility {
    ...
    public static String getPrefferredDirectoryPathEx(Context mContext) {
        String directory = new StringBuilder(String.valueOf(StorageConfiguration.getBaseDirectory().getAbsolutePath())).append(mContext.getResources().getString(R.string.directory)).toString();
    ...
    public static String getPrefferredDirectoryPath(Context mContext, boolean showErrorMessage, boolean getPrefDirectoryNoMatterWhat, boolean isAppCamera) {
        ...
        if (isAppCamera) {
            ...
            directory = new StringBuilder(String.valueOf(StorageConfiguration.getBaseDirectory().getAbsolutePath())).append(mContext.getResources().getString(R.string.directory)).toString();
        }
        String prefDir = PreferenceManager.getDefaultSharedPreferences(mContext).getString("save_image_directory_custom", null);
        if (prefDir != null) {
